...
const LoginModal: React.FC = () => {
    ...
    return (
        <div className="toast-container position-fixed top-0 end-0 p-3">
            <div id="idToastLogin" className="toast rounded-4 shadow" role="alert" aria-live="assertive" aria-atomic="true"
                style={{ width: '100%', maxWidth: '500px' }} ref={refToast}>
                    <div className="toast-header" style={{ margin: '3rem 3rem 0rem 3rem', borderBottom: 'none' }}>
                        <h1 className="me-auto">Crea tu cuenta gratis</h1>
