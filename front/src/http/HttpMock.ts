...
export default class HttpMock implements IHttpApi {
    ...
    signUp = createAsyncThunk<AxiosResponse<string>,CredencialType>(
        'signUp',
        async (): Promise<AxiosResponse<string>> => {
            return Promise.resolve(
                mockAxiosResponse("Mock sign up successful", {})
            );
        }
    )
    ...
    onImagePaste(_file: File): Promise<AxiosResponse<ImagePasteRes>> {
        return Promise.resolve(mockAxiosResponse<ImagePasteRes>({
            name: "pasted_image.png",
        }))
    }
    
    onEmbed(_url: string): Promise<AxiosResponse<EmbededType>> {
        return Promise.resolve(mockAxiosResponse<EmbededType>({
            type: "oembed",
            title: "SIN BOMBAS NUCLEARES Europa no tiene poder real - @SoloFonseca",
            description: "Solo Fonseca",
            thumbnail: "https://i.ytimg.com/vi/Sb_Bh1xiQsM/hqdefault.jpg",
            embed_html: "<iframe width=\"200\" height=\"113\" src=\"https://www.youtube.com/embed/Sb_Bh1xiQsM?feature=oembed\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen title=\"SIN BOMBAS NUCLEARES Europa no tiene poder real - @SoloFonseca\"></iframe>",
            url: "https://www.youtube.com/watch?v=Sb_Bh1xiQsM"
        }));
    }
}