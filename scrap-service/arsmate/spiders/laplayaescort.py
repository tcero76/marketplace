...
class LaplayaescortSpider(scrapy.Spider):
    name = "laplayaescort"
    allowed_domains = ["laplayaescort.cl"]
    ...
    def parse(self,response):
        ...
        self.headers = {
            "x-csrf-token": csrf,
            "Referer": "https://laplayaescort.cl/",
        ...
        yield scrapy.Request(
            self.base_url.format(2,version,1),
            callback=self.parse_first_page,
            headers=self.headers,
            meta={"version": version, "bloque": 2}
        )
        pass
